...
EM_AUTOINJECT_WATCH_TYPES = {
	"EmergencyMedicine.AutoInjectorWatchBlack",
	"EmergencyMedicine.AutoInjectorWatchBlackLeft",
	"EmergencyMedicine.AutoInjectorWatchRed",
	"EmergencyMedicine.AutoInjectorWatchRedLeft",
	"EmergencyMedicine.AutoInjectorWatchMetal",
	"EmergencyMedicine.AutoInjectorWatchMetalLeft",
	"EmergencyMedicine.AutoInjectorWatchLuxury",
	"EmergencyMedicine.AutoInjectorWatchLuxuryLeft",
}

-- the loadable ampoule drugs
EM_AUTOINJECT_AMPOULES = {
	"EmergencyMedicine.morphine",
	"EmergencyMedicine.naloxone",
	"EmergencyMedicine.fentanyl",
	"EmergencyMedicine.dexmedetomidine",
}
