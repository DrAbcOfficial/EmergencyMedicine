...
-- marker rides along for the duration (pure status, no
...
function TakeDexmedetomidine(player)
    ...
    -- the marker status rides along with the roll result for the record
    EM_DrugFx_Add(player, "ShoddySedation", { outcome = outcome })
