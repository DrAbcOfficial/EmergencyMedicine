-- EmergencyMedicine: official Build 42 registry identifiers.
...
EM = EM or {}
EM.MoodleTypes = {}
EM.MoodleTypes.OpioidAddiction = MoodleType.register("EmergencyMedicine:OpioidAddiction")
EM.MoodleTypes.OpioidWithdrawal = MoodleType.register("EmergencyMedicine:OpioidWithdrawal")
